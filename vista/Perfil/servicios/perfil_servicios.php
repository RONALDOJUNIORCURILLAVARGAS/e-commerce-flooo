...
$lis_servicio=$_SESSION['secta_servicio'];
...
<html>
    <head>
        ...
        <link href="../../../css/perfil/perfil_servicio.css" rel="stylesheet" type="text/css"/>
...
/*POPUP2*/
        ...
        var nombre_servicio;
        var id_servicio;
        function popup(mail,name,id_serv){
          correo_mail=mail;
        ...
        function solicitar(){
                ...
                window.document.form.servicio.value=nombre_servicio;
                window.document.form.id_servicio.value=id_servicio;
                window.document.form.opcion.value='2';
                window.document.form.submit();

        }
        function buscar(){
                window.document.form.action="../../../controladores/controlador_filtrar_servicio_perf.php";
                window.document.form.method="GET";
                window.document.form.opcion_busqueda.value='1';
                window.document.form.submit();
        }
        function bucar_categoria(id){
                window.document.form.action="../../../controladores/controlador_filtrar_servicio_perf.php";
                window.document.form.method="GET";
            ...
            <main>
               <center>
                            ...
                            <br>
                                ...
                                <table cellspacing="0">
                                    <tr>
                                        <td><div class="buscador"><input type="text" placeholder="Buscar servicios " name="txtbuscar" >
                                  ...
                                  <table>
                                    <tr>
                                       <input class="btn_reg" type="button" value="Añadir Servicios" onclick="añadirServicio('1')" >
                                    </tr>
                                    </table>
                            ...
                            <div class="richiboy">
                                    <div class="categorias">
                                            ...
                                            <h2><a onclick="bucar_categoria(1)" > <span class="Icon icon-heart"></span> Carpintería</a> </h2>
                                            <h2><a onclick="bucar_categoria(2)"><span class="Icon icon-home2"> </span> Gasfitería</a></h2>
                                            <h2><a onclick="bucar_categoria(3)"><span class="Icon icon-mobile"> </span> Electrónica</a></h2>
                                            <h2><a onclick="bucar_categoria(4)"><span class="Icon icon-woman"> </span> Gastronomía</a></h2>
                                            <h2><a onclick="bucar_categoria(5)"><span class="Icon icon-accessibility"> </span> Deportes</a></h2>
                                            <h2><a onclick="bucar_categoria(6)"><span class="Icon icon-windows"></span> Informática</a></h2>
                                            <h2><a onclick="bucar_categoria(7)"><span class="Icon icon-glass"></span> Construcción</a></h2>
                                        </div>
                                                ...
                                                <div class="div01">
                                                    ...
                                                    <ul style="margin-bottom:0px;">
                                                            <?php foreach ($lis_servicio as $value) {?>
                                                            <li class="mostrar_lis"  onclick="popup('<?php echo $value['CORREO_USUARIO']; ?>','<?php echo $value['NOMBRE_SERVICIO']; ?>','<?php echo $value['ID_SERVICIO']; ?>')"><label style="margin-top:5px;"><?php echo $value['NOMBRE_SERVICIO']; ?></label>
                                                                <div class="lista_contenido">
                                                                    <label class="lis_label">Descripcion : <?php echo $value['DESCRIPCION_SERVICIO']; ?></label>
                                                                   <!-- <label class="lis_label">Precio : S/ <?php echo $value['PRECIO']; ?></label> -->
                                                                    <label class="lis_label">Categoria :  <?php echo $value['NOMBRE_CAT_SERV']; ?></label>
                                                                </div>
                                                            </li>
                                                            <?php } ?>
                    ...
                    <form action=""> -->
                        <div class="contenedor-inputs">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td colspan="2">¿ Desea añadir un mensaje al que brinda el servicio ?</td>
                                    ...
                                    <tr>
                                        <td colspan="2">Puede dejar en blanco y dar click en solicitar</td>

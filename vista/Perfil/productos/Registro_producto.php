...
<html>
    ...
    <body>
        <main >
                    ...
                    <input type="button" class="btn btn-success" value="Regresar" onclick="regresar_producto('1')" style="float: left;"><br>
               ...
               <center>
                ...
                <h2>Añadir Producto</h2>
                   ...
                   <div class="form-group">
                        ...
                        <td><input class="form-control" type="number" placeholder="Cantidad" id="espec" name="txtcantidad"/>
                   </div>
                   <div class="form-group">
                ...
                <table class="btnpublicar">
                    <button type="submit" class="btn btn-success" onclick="RegistrarProducto('2')" >Publicar Producto</button><br>
                </table>
